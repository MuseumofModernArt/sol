...
/*!
      ...
      !*/
s.addTest("cssfilters",(function(){if(s.supports)return C("filter","blur(2px)");var e=u("a");return e.style.cssText=d.join("filter:blur(2px); "),!!e.style.length&&(void 0===t.documentMode||t.documentMode>9)})),
/*!
      {
      "name": "Flexbox",
      "property": "flexbox",
...
/*!
      ...
      !*/
s.addTest("cssmask",C("maskRepeat","repeat-x",!0));
/*!
      {
